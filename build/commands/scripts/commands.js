...
function AddCommonBuildOptions(commandLine) {
  return commandLine
    ...
    .option('--brave_debug_symbol_level <level>', '(0 = no symbol archive, 1 = only breakpad, 2 = breakpad + native(i.e. pdb) symbol archive)', parseInteger)
...
AddCommonBuildOptions(program.command('build'))
...
AddCommonBuildOptions(program.command('create_dist'))
